				...
				<ul class="nav navbar-nav pull-right">
							...
							<li>
								<ul class="dropdown-menu-list scroller" style="height: 275px;"
									...
									<li><a href="inbox.html?a=view"> <span class="photo">
												<img src="${root}/assets/layouts/layout/img/avatar2.jpg"
									...
									<li><a href="inbox.html?a=view"> <span class="photo">
												<img src="${root}/assets/layouts/layout/img/avatar3.jpg"
												class="img-circle" alt="" />
									...
									<li><a href="inbox.html?a=view"> <span class="photo">
												<img src="${root}/assets/layouts/layout/img/avatar1.jpg"
												class="img-circle" alt="" />
					...
					<li class="dropdown dropdown-user"><a href="javascript:;"
						...
						data-hover="dropdown" data-close-others="true"> <img alt=""
							...
							class="username username-hide-on-mobile"> ${loginUserName}
