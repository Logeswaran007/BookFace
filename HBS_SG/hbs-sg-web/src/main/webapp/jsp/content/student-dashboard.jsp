...
<link href="${root}/assets/global/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css"/>
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner container">
		<!-- BEGIN LOGO -->
		<div class="page-logo">
			<a href="${root}/}"><img src="${root}/academia/img/home2/logo-white.png" alt="" /></a>
			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
							...
							<li>
								<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
									<li>
										...
										<span class="photo">
										<img src="${root}/assets/admin/layout3/img/avatar2.jpg" class="img-circle" alt=""/>
										</span>
										<span class="subject">
										<span class="from">
										Lisa Wong </span>
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo">
										<img src="${root}/assets/admin/layout3/img/avatar3.jpg" class="img-circle" alt=""/>
										</span>
										<span class="subject">
										<span class="from">
										Richard Doe </span>
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo">
										<img src="${root}/assets/admin/layout3/img/avatar1.jpg" class="img-circle" alt=""/>
										</span>
										<span class="subject">
										<span class="from">
										Bob Nilson </span>
					...
					<li class="dropdown dropdown-user">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						<img alt="" class="img-circle" src="${root}/assets/admin/layout2/img/avatar3_small.jpg"/>
						...
						<ul class="dropdown-menu dropdown-menu-default">
							...
							<li>
								<a href="${root}/d56b699830e77ba53855679234252dae">
								<i class="icon-lock"></i> Lock Screen </a>
							</li>
							<li>
								<a href="${root}/a440a662cc8253d7536e5aa17942">
						...
						<div class="portlet light ">
							...
							<div class="portlet-body">
								<div id="site_statistics_loading">
									<img src="${root}/assets/admin/layout2/img/loading.gif}" alt="loading"/>
								</div>
								...
								<div class="actions">
									<div class="btn-group">
										...
										<div class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
											...
											<label><input type="checkbox" checked="checked"/> Membership</label>
											<label><input type="checkbox"/> Customer Support</label>
											<label><input type="checkbox" checked="checked"/> HR</label>
										...
										<div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
											<div class="row">
												<div class="col-md-6 user-info">
													<img alt="" src="${root}/assets/admin/layout2/img/avatar.png" class="img-responsive"/>
													<div class="details">
														<div>
															<a href="javascript:;">
															Robert Nilson </a>
						...
						<div class="portlet light ">
							...
							<div class="portlet-body" id="chats">
								<div class="scroller" style="height: 353px;" data-always-visible="1" data-rail-visible1="1">
									<ul class="chats">
										<li class="in">
											<img class="avatar" alt="" src="${root}/assets/admin/layout2/img/avatar1.jpg"/>
											<div class="message">
												<span class="arrow">
												</span>
										...
										<li class="out">
											<img class="avatar" alt="" src="${root}/assets/admin/layout2/img/avatar2.jpg"/>
											<div class="message">
												<span class="arrow">
												</span>
												<a href="javascript:;" class="name">
										...
										<li class="out">
											<img class="avatar" alt="" src="${root}/assets/admin/layout2/img/avatar3.jpg"/>
											<div class="message">
												<span class="arrow">
												</span>
												<a href="javascript:;" class="name">
								...
								<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
									...
									<ul class="media-list list-items">
										<li class="media">
											...
											<img class="media-object" src="${root}/assets/admin/layout/img/avatar3.jpg" alt="..."/>
										...
										<li class="media">
											<img class="media-object" src="${root}/assets/admin/layout/img/avatar1.jpg" alt="..."/>
											<div class="media-body">
										...
										<li class="media">
											...
											<img class="media-object" src="${root}/assets/admin/layout/img/avatar4.jpg" alt="..."/>
											<div class="media-body">
										...
										<li class="media">
											<img class="media-object" src="${root}/assets/admin/layout/img/avatar2.jpg" alt="..."/>
											<div class="media-body">
									...
									<ul class="media-list list-items">
										<li class="media">
											...
											<img class="media-object" src="${root}/assets/admin/layout/img/avatar6.jpg" alt="..."/>
											<div class="media-body">
										...
										<li class="media">
											...
											<img class="media-object" src="${root}/assets/admin/layout/img/avatar7.jpg" alt="..."/>
											<div class="media-body">
										...
										<li class="media">
											<img class="media-object" src="${root}/assets/admin/layout/img/avatar8.jpg" alt="..."/>
											<div class="media-body">
										...
										<li class="media">
											...
											<img class="media-object" src="${root}/assets/admin/layout/img/avatar9.jpg" alt="..."/>
											<div class="media-body">
										...
										<li class="media">
											<img class="media-object" src="${root}/assets/admin/layout/img/avatar10.jpg" alt="..."/>
											<div class="media-body">
										...
										<li class="media">
											...
											<img class="media-object" src="${root}/assets/admin/layout/img/avatar11.jpg" alt="..."/>
											<div class="media-body">
								...
								<div class="page-quick-sidebar-item">
									<div class="page-quick-sidebar-chat-user">
										...
										<div class="page-quick-sidebar-chat-user-messages">
											<div class="post out">
												<img class="avatar" alt="" src="${root}/assets/admin/layout/img/avatar3.jpg"/>
												<div class="message">
											...
											<div class="post in">
												<img class="avatar" alt="" src="${root}/assets/admin/layout/img/avatar2.jpg"/>
												<div class="message">
													<span class="arrow"></span>
							...
							<div class="tab-pane page-quick-sidebar-settings" id="quick_sidebar_tab_3">
								<div class="page-quick-sidebar-settings-list">
									...
									<ul class="list-items borderless">
										<li>
											 Enable Notifications <input type="checkbox" class="make-switch" checked="checked" data-size="small" data-on-color="success" data-on-text="ON" data-off-color="default" data-off-text="OFF"/>
										</li>
										<li>
											 Allow Tracking <input type="checkbox" class="make-switch" data-size="small" data-on-color="info" data-on-text="ON" data-off-color="default" data-off-text="OFF"/>
										</li>
										<li>
											 Log Errors <input type="checkbox" class="make-switch" checked="checked" data-size="small" data-on-color="danger" data-on-text="ON" data-off-color="default" data-off-text="OFF"/>
										</li>
										<li>
											 Auto Sumbit Issues <input type="checkbox" class="make-switch" data-size="small" data-on-color="warning" data-on-text="ON" data-off-color="default" data-off-text="OFF"/>
										</li>
										<li>
											 Enable SMS Alerts <input type="checkbox" class="make-switch" checked="checked" data-size="small" data-on-color="success" data-on-text="ON" data-off-color="default" data-off-text="OFF"/>
										</li>
									</ul>
									...
									<ul class="list-items borderless">
										...
										<li>
											 Notify On System Error <input type="checkbox" class="make-switch" checked="checked" data-size="small" data-on-color="danger" data-on-text="ON" data-off-color="default" data-off-text="OFF"/>
										</li>
										<li>
											 Notify On SMTP Error <input type="checkbox" class="make-switch" checked="checked" data-size="small" data-on-color="warning" data-on-text="ON" data-off-color="default" data-off-text="OFF"/>
										</li>
									</ul>
...
<script src="${root}/assets/global/plugins/jquery.pulsate.min.js" type="text/javascript"></script>
<script src="${root}/assets/global/plugins/bootstrap-daterangepicker/moment.min.js" type="text/javascript"></script>
<script src="${root}/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.js" type="text/javascript"></script>
...
<script src="${root}/assets/admin/layout2/scripts/quick-sidebar.js" type="text/javascript"></script>
<script src="${root}/assets/admin/layout2/scripts/demo.js" type="text/javascript"></script>
<script src="${root}/assets/admin/pages/scripts/index.js" type="text/javascript"></script>
<script src="${root}/assets/admin/pages/scripts/tasks.js" type="text/javascript"></script>
