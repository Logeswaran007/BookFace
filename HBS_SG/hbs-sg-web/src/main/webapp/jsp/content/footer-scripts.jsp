...
<!-- BEGIN CORE PLUGINS -->
 ...
 <script src="${root}/assets/global/plugins/amcharts/amcharts/amcharts.js" type="text/javascript"></script>
 <script src="${root}/assets/global/plugins/amcharts/amcharts/serial.js" type="text/javascript"></script>
 <script src="${root}/assets/global/plugins/amcharts/amcharts/pie.js" type="text/javascript"></script>
 <script src="${root}/assets/global/plugins/amcharts/amcharts/radar.js" type="text/javascript"></script>
 <script src="${root}/assets/global/plugins/amcharts/amcharts/themes/light.js" type="text/javascript"></script>
 <script src="${root}/assets/global/plugins/amcharts/amcharts/themes/patterns.js" type="text/javascript"></script>
 <script src="${root}/assets/global/plugins/amcharts/amcharts/themes/chalk.js" type="text/javascript"></script>
 <script src="${root}/assets/global/plugins/amcharts/ammap/ammap.js" type="text/javascript"></script>
 <script src="${root}/assets/global/plugins/amcharts/ammap/maps/js/worldLow.js" type="text/javascript"></script>
 <script src="${root}/assets/global/plugins/amcharts/amstockcharts/amstock.js" type="text/javascript"></script>
 <script src="${root}/assets/global/plugins/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
 <script src="${root}/assets/global/plugins/horizontal-timeline/horizontal-timeline.js" type="text/javascript"></script>
