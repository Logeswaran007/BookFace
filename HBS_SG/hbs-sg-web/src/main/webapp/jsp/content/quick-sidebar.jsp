					...
					<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
						...
						<ul class="media-list list-items">
							<li class="media">
								...
								src="${root}/assets/layouts/layout/img/avatar3.jpg" alt="..." />
							...
							<li class="media"><img class="media-object"
								src="${root}/assets/layouts/layout/img/avatar1.jpg" alt="..." />
								<div class="media-body">
							...
							<li class="media">
								...
								src="${root}/assets/layouts/layout/img/avatar4.jpg" alt="..." />
								<div class="media-body">
							...
							<li class="media"><img class="media-object"
								src="${root}/assets/layouts/layout/img/avatar2.jpg" alt="..." />
								<div class="media-body">
						...
						<ul class="media-list list-items">
							<li class="media">
								...
								src="${root}/assets/layouts/layout/img/avatar6.jpg" alt="..." />
								<div class="media-body">
							...
							<li class="media">
								...
								src="${root}/assets/layouts/layout/img/avatar7.jpg" alt="..." />
								<div class="media-body">
							...
							<li class="media"><img class="media-object"
								src="${root}/assets/layouts/layout/img/avatar8.jpg" alt="..." />
								<div class="media-body">
							...
							<li class="media">
								...
								src="${root}/assets/layouts/layout/img/avatar9.jpg" alt="..." />
								<div class="media-body">
							...
							<li class="media"><img class="media-object"
								src="${root}/assets/layouts/layout/img/avatar10.jpg" alt="..." />
								<div class="media-body">
							...
							<li class="media">
								...
								src="${root}/assets/layouts/layout/img/avatar11.jpg" alt="..." />
								<div class="media-body">
							...
							<div class="page-quick-sidebar-chat-user-messages">
								<div class="post out">
									<img class="avatar" alt=""
										src="${root}/assets/layouts/layout/img/avatar3.jpg" />
									<div class="message">
								...
								<div class="post in">
									<img class="avatar" alt=""
										src="${root}/assets/layouts/layout/img/avatar2.jpg" />
									<div class="message">
										<span class="arrow"></span> <a href="javascript:;"
					...
					<div class="page-quick-sidebar-settings-list">
						...
						<ul class="list-items borderless">
							...
							<li>Log Errors <input type="checkbox" class="make-switch"
								checked="checked" data-size="small" data-on-color="danger"
								data-on-text="ON" data-off-color="default" data-off-text="OFF" />
							</li>
