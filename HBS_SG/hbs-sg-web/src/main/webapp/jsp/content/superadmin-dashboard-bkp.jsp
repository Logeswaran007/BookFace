...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${root}/assets/global/plugins/bootstrap/css/bootstrap.min.css"
	rel="stylesheet" type="text/css" />
<link
...
<link
	href="${root}/assets/global/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css"
	rel="stylesheet" type="text/css" />
<link
	href="${root}/assets/global/plugins/fullcalendar/fullcalendar.min.css"
	rel="stylesheet" type="text/css" />
<link href="${root}/assets/global/plugins/jqvmap/jqvmap/jqvmap.css"
	rel="stylesheet" type="text/css" />
<!-- END PAGE LEVEL PLUGIN STYLES -->
<!-- BEGIN PAGE STYLES -->
<link href="${root}/assets/admin/pages/css/tasks.css" rel="stylesheet"
	type="text/css" />
<!-- END PAGE STYLES -->
<!-- BEGIN THEME STYLES -->
<!-- DOC: To use 'rounded corners' style just load 'components-rounded.css' stylesheet instead of 'components.css' in the below style tag -->
<link href="${root}/assets/global/css/components.css"
	id="style_components" rel="stylesheet" type="text/css" />
<link href="${root}/assets/global/css/plugins.css" rel="stylesheet"
	type="text/css" />
<link href="${root}/assets/admin/layout2/css/layout.css"
	rel="stylesheet" type="text/css" />
<link href="${root}/assets/admin/layout2/css/themes/grey.css"
	rel="stylesheet" type="text/css" id="style_color" />
<link href="${root}/assets/admin/layout2/css/custom.css"
	rel="stylesheet" type="text/css" />
<!-- END THEME STYLES -->
		...
		<div class="page-header-inner container">
			...
			<div class="page-logo">
				<a href="javascript:;"><img
					src="${root}/academia/img/home2/logo-default.png" alt="logo"
					class="logo-default" /></a>
				<div class="menu-toggler sidebar-toggler">
					<!-- DOC: Remove the above "hide" to enable the sidebar toggler button on gheader -->
				</div>
			</div>
			<!-- END LOGO -->
			...
			<div class="page-actions hide">
				<div class="btn-group">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a href="javascript:;"> <i class="icon-user"></i> New
								User
						</a></li>
						<li><a href="javascript:;"> <i class="icon-present"></i>
								New Event <span class="badge badge-success">4</span>
						</a></li>
						<li><a href="javascript:;"> <i class="icon-basket"></i>
								New order
						</a></li>
						<li class="divider"></li>
						<li><a href="javascript:;"> <i class="icon-flag"></i>
								Pending Orders <span class="badge badge-danger">4</span>
						</a></li>
					...
					<ul class="nav navbar-nav pull-right">
								...
								<li>
									<ul class="dropdown-menu-list scroller" style="height: 275px;"
										...
										<li><a href="inbox.html?a=view"> <span class="photo">
													<img src="${root}/assets/admin/layout3/img/avatar2.jpg"
										...
										<li><a href="inbox.html?a=view"> <span class="photo">
													<img src="${root}/assets/admin/layout3/img/avatar3.jpg"
													class="img-circle" alt="" />
											</span> <span class="subject"> <span class="from">
										...
										<li><a href="inbox.html?a=view"> <span class="photo">
													<img src="${root}/assets/admin/layout3/img/avatar1.jpg"
													class="img-circle" alt="" />
						...
						<li class="dropdown dropdown-user"><a href="javascript:;"
							...
							data-hover="dropdown" data-close-others="true"> <img alt=""
								class="img-circle" src="${loginUserImage}" /> <span
								class="username username-hide-on-mobile">
									${loginUserName} </span> <i class="fa fa-angle-down"></i>
						</a>
							<ul class="dropdown-menu dropdown-menu-default">
								...
								<li class="divider"></li>
								<li><a href="${root}/d56b699830e77ba53855679234252dae">
										<i class="icon-lock"></i> Lock Screen
								</a></li>
								<li><a href="${root}/a440a662cc8253d7536e5aa17942"> <i
									...
									<div class="actions">
										<div class="btn-group">
											<a class="btn btn-sm btn-default btn-circle"
												...
												data-hover="dropdown" data-close-others="true"> Filter
									...
									<div class="actions">
										<div class="btn-group">
											...
											<ul class="dropdown-menu pull-right">
												<li><a href="javascript:;"> <i class="i"></i> All
														Project
												</a></li>
												<li class="divider"></li>
							...
							<div class="portlet light ">
								...
								<div class="portlet-body">
									<div id="site_statistics_loading">
										<img src="${root}/assets/admin/layout2/img/loading.gif}"
											alt="loading" />
									</div>
									...
									<div class="actions">
										<div class="btn-group">
											...
											<ul class="dropdown-menu pull-right">
												...
												<li class="active"><a href="javascript:;"> Q3 2014
														<span class="label label-sm label-success"> current
													</span>
												</a></li>
									...
									<div style="margin: 20px 0 10px 30px">
										<div class="row">
											<div class="col-md-3 col-sm-3 col-xs-6 text-stat">
												<span class="label label-sm label-success"> Revenue:
												</span>
												<h3>$13,234</h3>
											</div>
											<div class="col-md-3 col-sm-3 col-xs-6 text-stat">
												<span class="label label-sm label-danger"> Shipment:
												</span>
												<h3>$1,134</h3>
											</div>
											<div class="col-md-3 col-sm-3 col-xs-6 text-stat">
											...
											<div class="scroller" style="height: 290px;"
												...
												<div class="row">
													<div class="col-md-6 user-info">
														<img alt=""
															src="${root}/assets/admin/layout2/img/avatar.png"
															class="img-responsive" />
														<div class="details">
															<div>
																<a href="javascript:;"> Robert Nilson </a> <span
													...
													<div class="col-md-6 user-info">
														...
														<div class="details">
															<div>
																<a href="javascript:;"> Lisa Miller </a> <span
												...
												<div class="row">
													<div class="col-md-6 user-info">
														...
														<div class="details">
															<div>
																<a href="javascript:;"> Eric Kim </a> <span
																	class="label label-sm label-info"> Pending </span>
															</div>
								...
								<div class="portlet-title ">
									<div class="caption">
										<i class="icon-calendar font-green-sharp"></i> <span
											class="caption-subject font-green-sharp bold uppercase">Calendar</span>
									</div>
								</div>
								<div class="portlet-body">
									<div id="calendar"></div>
						...
						<div class="col-md-6 col-sm-6">
							...
							<div class="portlet light ">
								...
								<div class="portlet-body" id="chats">
									<div class="scroller" style="height: 353px;"
										data-always-visible="1" data-rail-visible1="1">
										<ul class="chats">
											<li class="in"><img class="avatar" alt=""
												src="${root}/assets/admin/layout2/img/avatar1.jpg" />
												<div class="message">
													<span class="arrow"> </span> <a href="javascript:;"
														class="name"> Bob Nilson </a> <span class="datetime">
														at 20:09 </span> <span class="body"> Lorem ipsum dolor sit
														amet, consectetuer adipiscing elit, sed diam nonummy nibh
														euismod tincidunt ut laoreet dolore magna aliquam erat
														volutpat. </span>
												</div></li>
											<li class="out"><img class="avatar" alt=""
												src="${root}/assets/admin/layout2/img/avatar2.jpg" />
												<div class="message">
													<span class="arrow"> </span> <a href="javascript:;"
											...
											<li class="out"><img class="avatar" alt=""
												src="${root}/assets/admin/layout2/img/avatar3.jpg" />
												<div class="message">
													<span class="arrow"> </span> <a href="javascript:;"
									...
									<div class="page-quick-sidebar-chat-users"
										...
										<ul class="media-list list-items">
											<li class="media">
												...
												src="${root}/assets/admin/layout/img/avatar3.jpg" alt="..." />
											...
											<li class="media"><img class="media-object"
												src="${root}/assets/admin/layout/img/avatar1.jpg" alt="..." />
												<div class="media-body">
											...
											<li class="media">
												...
												src="${root}/assets/admin/layout/img/avatar4.jpg" alt="..." />
												<div class="media-body">
											...
											<li class="media"><img class="media-object"
												src="${root}/assets/admin/layout/img/avatar2.jpg" alt="..." />
												<div class="media-body">
										...
										<ul class="media-list list-items">
											<li class="media">
												...
												src="${root}/assets/admin/layout/img/avatar6.jpg" alt="..." />
												<div class="media-body">
											...
											<li class="media">
												...
												src="${root}/assets/admin/layout/img/avatar7.jpg" alt="..." />
												<div class="media-body">
											...
											<li class="media"><img class="media-object"
												src="${root}/assets/admin/layout/img/avatar8.jpg" alt="..." />
												<div class="media-body">
											...
											<li class="media">
												...
												src="${root}/assets/admin/layout/img/avatar9.jpg" alt="..." />
												<div class="media-body">
											...
											<li class="media"><img class="media-object"
												src="${root}/assets/admin/layout/img/avatar10.jpg" alt="..." />
												<div class="media-body">
											...
											<li class="media">
												...
												src="${root}/assets/admin/layout/img/avatar11.jpg" alt="..." />
												<div class="media-body">
											...
											<div class="page-quick-sidebar-chat-user-messages">
												<div class="post out">
													<img class="avatar" alt=""
														src="${root}/assets/admin/layout/img/avatar3.jpg" />
													<div class="message">
														<span class="arrow"></span> <a href="javascript:;"
												...
												<div class="post in">
													<img class="avatar" alt=""
														src="${root}/assets/admin/layout/img/avatar2.jpg" />
													<div class="message">
														<span class="arrow"></span> <a href="javascript:;"
									...
									<div class="page-quick-sidebar-settings-list">
										...
										<ul class="list-items borderless">
											<li>Enable Notifications <input type="checkbox"
												class="make-switch" checked="checked" data-size="small"
...
<![endif]-->
	...
	<script src="${root}/assets/global/plugins/jquery-ui/jquery-ui.min.js"
		type="text/javascript"></script>
	<script
		src="${root}/assets/global/plugins/bootstrap/js/bootstrap.min.js"
		type="text/javascript"></script>
	<script
	...
	<script
		src="${root}/assets/global/plugins/jqvmap/jqvmap/jquery.vmap.js"
		type="text/javascript"></script>
	<script
		src="${root}/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js"
		type="text/javascript"></script>
	<script
		src="${root}/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js"
		type="text/javascript"></script>
	<script
		src="${root}/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.js"
		type="text/javascript"></script>
	<script
		src="${root}/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js"
		type="text/javascript"></script>
	<script
		src="${root}/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.js"
		type="text/javascript"></script>
	<script
		src="${root}/assets/global/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js"
		type="text/javascript"></script>
	<script src="${root}/assets/global/plugins/flot/jquery.flot.min.js"
		type="text/javascript"></script>
	<script
		src="${root}/assets/global/plugins/flot/jquery.flot.resize.min.js"
		type="text/javascript"></script>
	<script
		src="${root}/assets/global/plugins/flot/jquery.flot.categories.min.js"
		type="text/javascript"></script>
	<script src="${root}/assets/global/plugins/jquery.pulsate.min.js"
		type="text/javascript"></script>
	<script
		src="${root}/assets/global/plugins/bootstrap-daterangepicker/moment.min.js"
		type="text/javascript"></script>
	<script
		src="${root}/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.js"
		type="text/javascript"></script>
	<!-- IMPORTANT! fullcalendar depends on jquery-ui.min.js for drag & drop support -->
	<script
		src="${root}/assets/global/plugins/fullcalendar/fullcalendar.min.js"
		type="text/javascript"></script>
	<script
		src="${root}/assets/global/plugins/jquery-easypiechart/jquery.easypiechart.min.js"
		type="text/javascript"></script>
	<script src="${root}/assets/global/plugins/jquery.sparkline.min.js"
		type="text/javascript"></script>
	<!-- END PAGE LEVEL PLUGINS -->
	<!-- BEGIN PAGE LEVEL SCRIPTS -->
	<script src="${root}/assets/global/scripts/metronic.js"
		type="text/javascript"></script>
	<script src="${root}/assets/admin/layout2/scripts/layout.js"
		type="text/javascript"></script>
	<script src="${root}/assets/admin/layout2/scripts/quick-sidebar.js"
		type="text/javascript"></script>
	<script src="${root}/assets/admin/layout2/scripts/demo.js"
		type="text/javascript"></script>
	<script src="${root}/assets/admin/pages/scripts/index.js"
		type="text/javascript"></script>
	<script src="${root}/assets/admin/pages/scripts/tasks.js"
		type="text/javascript"></script>
