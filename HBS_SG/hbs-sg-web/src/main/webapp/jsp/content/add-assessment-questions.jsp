							...
							<table class="table" style="margin-bottom: 0px;"
								...
								<tbody>
									<tr>
										...
										<td class="col-md-5" align="center"><form:textarea
...
<script type="text/javascript">
	...
	function onsubmitCalled(isNext) {
		...
		data["textExplanation"] = $("#textExplanationId").val();
		data["textAnswer1"] = $("#textAnswer1ID").val();
		...
		alert("correctAnswer1"+$("#checkBoxcorrectAns1").val());
		alert("correctAnswer2"+$("#checkBoxcorrectAns2").val());
		alert("correctAnswer3"+$("#checkBoxcorrectAns3").val());
		alert("correctAnswer4"+$("#checkBoxcorrectAns4").val());
	...
	alert($("#checkBoxcorrectAns4").val());	
		...
		$.ajax({
			type : "POST",
			enctype : 'multipart/form-data',
			url : "${root}/a878938a9edee32ea63b2c52be55f3f7",
			processData : false, //prevent jQuery from automatically transforming the data into a query string
			contentType : false,
			cache : false,
			timeout : 600000,
