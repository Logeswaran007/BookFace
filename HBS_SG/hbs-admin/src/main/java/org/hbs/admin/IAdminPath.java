...
public interface IAdminPath extends IConstProperty
{
	...
	{
		User, Producer, Consumer, Employee, UserLog, Roles, UserRoles, DefaultImageUpload, DefaultImageDownload, ImageUpload, ImageDownload, UserAddress
	}

	public enum EUserTemplate implements EnumInterface
	{
		User_Create, User_Create_Consumer, User_Create_Admin, User_Reset_Password, User_Create_Producer, User_Create_Employee;
	}
