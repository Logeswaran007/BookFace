...
-- Dumping data for table education.authkeygen: ~7 rows (approximately)
...
-- Dumping data for table education.layoutelements: ~91 rows (approximately)
DELETE FROM `layoutelements`;
/*!40000 ALTER TABLE `layoutelements` DISABLE KEYS */;
INSERT INTO `layoutelements` (`elementId`, `displayName`, `displayProperty`, `displayPropertyGetter`, `render`, `columnType`, `dataType`, `transformerBeanName`) VALUES
	('AKCountry', ' ', 'createdUser.country.country', NULL, NULL, 'String', 'String', NULL),
	('AKCreatedDate', 'Created Date', 'createdDate', 'getCreatedDateByTimeZone()', NULL, 'String', 'String', 'org.hbs.util.transformer.DateTimeTransformer'),
	('AKCreatedFirstName', 'Created By', 'createdUser.usUserName', NULL, NULL, 'String', 'String', NULL),
	('AKCreatedLastName', '', 'createdUser.usLastName', NULL, NULL, 'String', 'String', NULL),
	('AKFirstName', 'Assigned To', 'users.usUserName', NULL, NULL, 'String', 'String', NULL),
	('AKKeyStatus', 'Key Status', 'serialKeyStatus', NULL, NULL, 'String', 'String', NULL),
	('AKLastName', '', 'users.usLastName', NULL, NULL, 'String', 'String', NULL),
	('AKSchemeCost', 'Scheme Cost', 'scheme.schemeCost', NULL, NULL, 'String', 'String', NULL),
	('AKSchemeName', 'Scheme', 'scheme.schemeName', NULL, NULL, 'String', 'String', NULL),
	('AKSellingPrice', 'Selling', 'sellingPrice', NULL, NULL, 'String', 'String', NULL),
	('AKSerialKey', 'Serial Key', 'serialKey', NULL, NULL, 'String', 'String', NULL),
	('AKSerialKeyChkBox', '<center><input type="checkbox" class="editor-active" name="serialKeyColumnHeadId" id="serialKeyColumnHeadId" value="" onchange="onSelectAllCheckBox();"></input></center>', 'serialKey', NULL, NULL, 'String', 'String', NULL),
	('ASS0001', 'Assessment Name', 'name', 'getName()', NULL, 'String', 'String', NULL),
	('ASS0002', 'Subject', 'course.courseName', 'getCourse().getCourseName()', NULL, 'String', 'String', NULL),
	('ASS0003', 'Chapter', 'chapter.chapterName', 'getChapter().getChapterName()', NULL, 'String', 'String', NULL),
	('ASS0004', 'Section', 'course.courseGroup.courseGroupSection', 'getCourse().getCourseGroup().getCourseGroupSection()', NULL, 'String', 'String', NULL),
	('ASS0005', 'Syllabus Type', 'course.courseGroup.courseBatch', 'getCourse().getCourseGroup().getCourseBatch()', NULL, 'String', 'String', NULL),
	('ASS0006', 'Exam Date', 'info.assessmentDate', 'getInfo().getAssessmentDate()', NULL, 'String', 'String', NULL),
	('ASS0007', 'Duration', 'info.duration', 'getInfo().getDuration()', NULL, 'String', 'String', NULL),
	('ASS0008', 'Created By', 'createdUser.usUserName', 'getCreatedUser().getUsUserName()', NULL, 'String', 'String', NULL),
	('ASS0008-1', '', 'createdUser.usLastName', 'getCreatedUser().getUsLastName()', NULL, 'String', 'String', NULL),
	('ASS0009', 'Created Date ', 'createdDateByTimeZone', 'getCreatedDateByTimeZone()', NULL, 'String', 'String', NULL),
	('ASS0010', 'Public', 'info.broadCast', 'getInfo().isBroadCast()', NULL, 'String', 'String', NULL),
	('ASS0011', 'Status', 'status', 'getStatus()', NULL, 'String', 'String', NULL),
	('ASS0012', 'Delete', 'status', 'getStatus()', NULL, 'String', 'String', NULL),
	('EXPAND', '', '', '', NULL, 'String', 'String', NULL),
	('ORGAdd1', '', 'addressLine1', NULL, NULL, 'String', 'String', NULL),
	('ORGAdd2', '', 'addressLine2', NULL, NULL, 'String', 'String', NULL),
	('ORGAdd3', '', 'addressLine3', NULL, NULL, 'String', 'String', NULL),
	('ORGCity', 'City', 'city', NULL, NULL, 'String', 'String', NULL),
	('ORGCountry', 'Country', 'country.countryName', NULL, NULL, 'String', 'String', NULL),
	('ORGCreatedCountry', ' ', 'organisation.createdUser.country.country', NULL, NULL, 'String', 'String', NULL),
	('ORGCreatedDate', 'Created Date', 'organisation.createdDate', 'getCreatedDateByTimeZone()', NULL, 'String', 'String', 'org.hbs.util.transformer.DateTimeTransformer'),
	('ORGCreatedFirstName', 'Created By', 'organisation.createdUser.usUserName', NULL, NULL, 'String', 'String', NULL),
	('ORGCreatedLastName', '', 'organisation.createdUser.usLastName', NULL, NULL, 'String', 'String', NULL),
	('ORGEmail', 'Email', 'email', NULL, NULL, 'String', 'String', NULL),
	('ORGId', '', 'organisation.organisationId', NULL, NULL, 'String', 'String', NULL),
	('ORGImage', 'View', 'uploadFileVirtualURL', NULL, NULL, 'String', 'String', 'org.hbs.util.transformer.AttachmentTransformer'),
	('ORGLandmark', 'Landmark', 'landmark', NULL, NULL, 'String', 'String', NULL),
	('ORGMobile', 'Mobile', 'mobileNo', NULL, NULL, 'String', 'String', NULL),
	('ORGName', 'Name', 'organisation.organisationName', NULL, NULL, 'String', 'String', NULL),
	('ORGPhone', 'Phone', 'primaryPhoneNo', NULL, NULL, 'String', 'String', NULL),
	('ORGPincode', 'Pincode', 'pincode', NULL, NULL, 'String', 'String', NULL),
	('ORGState', 'State', 'state.state', NULL, NULL, 'String', 'String', NULL),
	('ORGStatus', 'Status', 'status', NULL, NULL, 'String', 'String', NULL),
	('ORGWebsite', 'Website', 'website', NULL, NULL, 'String', 'String', NULL),
	('UA0001', 'Action', 'action', 'getAction()', NULL, 'String', 'String', NULL),
	('UA0002', 'Created By', 'createdUser.usUserName', 'getCreatedUser().getUsUserName()', NULL, 'String', 'String', NULL),
	('UA0003', 'Created Date', 'createdDateByTimeZone', 'getCreatedDateByTimeZone()', NULL, 'String', 'String', NULL),
	('UL0001', 'Login Time', 'ulUserLoginTime', 'getUlUserLoginTime()', NULL, 'String', 'String', NULL),
	('UL0002', 'Logout Time', 'ulUserLogoutTime', 'getUlUserLogoutTime()', NULL, 'String', 'String', NULL),
	('UL0003', 'IP Address', 'ulIpaddress', 'getUlIpaddress()', NULL, 'String', 'String', NULL),
	('USRAdd1', 'Address', 'addressLine1', NULL, NULL, 'String', 'String', NULL),
	('USRAdd2', '', 'addressLine2', NULL, NULL, 'String', 'String', NULL),
	('USRAdd3', '', 'addressLine3', NULL, NULL, 'String', 'String', NULL),
	('USRCity', 'City', 'city', NULL, NULL, 'String', 'String', NULL),
	('USRCountry', 'Country', 'country.countryName', NULL, NULL, 'String', 'String', NULL),
	('USRCreatedCountry', ' ', 'users.createdUser.country.country', NULL, NULL, 'String', 'String', NULL),
	('USRCreatedDate', 'Created Date', 'users.createdDate', 'getCreatedDateByTimeZone()', NULL, 'String', 'String', 'org.hbs.util.transformer.DateTimeTransformer'),
	('USRCreatedFirstName', 'Created By', 'users.createdUser.usUserName', NULL, NULL, 'String', 'String', NULL),
	('USRCreatedLastName', '', 'users.createdUser.usLastName', NULL, NULL, 'String', 'String', NULL),
	('USREmail', 'Email', 'email', NULL, NULL, 'String', 'String', NULL),
	('USRId', '', 'users.usEmployeeId', NULL, NULL, 'String', 'String', NULL),
	('USRLandmark', 'Landmark', 'landmark', NULL, NULL, 'String', 'String', NULL),
	('USRLastName', 'Name', 'users.usLastName', NULL, NULL, 'String', 'String', NULL),
	('USRMobile', 'Mobile', 'mobileNo', NULL, NULL, 'String', 'String', NULL),
	('USRName', 'Name', 'users.usUserName', NULL, NULL, 'String', 'String', NULL),
	('USRPhone', 'Phone', 'primaryPhoneNo', NULL, NULL, 'String', 'String', NULL),
	('USRPincode', 'Pincode', 'pincode', NULL, NULL, 'String', 'String', NULL),
	('USRState', 'State', 'state.state', NULL, NULL, 'String', 'String', NULL),
	('USRStatus', 'Status', 'status', NULL, NULL, 'String', 'String', NULL);
...
-- Dumping data for table education.layouts: ~94 rows (approximately)
DELETE FROM `layouts`;
...
-- Dumping data for table education.userlog: ~7 rows (approximately)
DELETE FROM `userlog`;
/*!40000 ALTER TABLE `userlog` DISABLE KEYS */;
INSERT INTO `userlog` (`ulAutoId`, `usEmployeeId`, `ulUserLoginTime`, `ulUserLogoutTime`, `ulIpaddress`, `ulFetchBlock`) VALUES
	(1, 'USR1513438024801', '2018-03-26 11:18:19', NULL, '0:0:0:0:0:0:0:1', b'0'),
	(2, 'USR1513438024801', '2018-03-26 11:22:38', NULL, '0:0:0:0:0:0:0:1', b'0'),
	(3, 'USR1513438024801', '2018-03-26 11:24:16', NULL, '0:0:0:0:0:0:0:1', b'0'),
	(4, 'USR1513438024801', '2018-03-26 11:26:46', '2018-03-26 11:29:48', '0:0:0:0:0:0:0:1', b'0'),
	(5, 'USR1513438024801', '2018-03-26 11:29:52', NULL, '0:0:0:0:0:0:0:1', b'0'),
	(6, 'USR1513438024801', '2018-03-26 11:32:40', NULL, '0:0:0:0:0:0:0:1', b'0'),
	(7, 'USR1513438024801', '2018-03-26 11:47:51', NULL, '0:0:0:0:0:0:0:1', b'0'),
	(8, 'USR1513438024801', '2018-03-26 21:49:37', '2018-03-26 22:48:17', '0:0:0:0:0:0:0:1', b'0'),
	(9, 'USR1513438024801', '2018-03-26 22:48:21', NULL, '0:0:0:0:0:0:0:1', b'0'),
	(10, 'USR1513438024801', '2018-03-26 22:48:54', '2018-03-26 22:59:12', '0:0:0:0:0:0:0:1', b'0'),
	(11, 'USR1513438024801', '2018-03-26 22:59:15', '2018-03-26 23:04:02', '0:0:0:0:0:0:0:1', b'0'),
	(12, 'USR1513438024801', '2018-03-26 23:04:07', '2018-03-26 23:04:22', '0:0:0:0:0:0:0:1', b'0'),
	(13, 'USR1513438024801', '2018-03-26 23:04:26', '2018-03-26 23:07:21', '0:0:0:0:0:0:0:1', b'0'),
	(14, 'USR1513438024801', '2018-03-26 23:07:25', '2018-03-26 23:09:32', '0:0:0:0:0:0:0:1', b'0'),
	(15, 'USR1513438024801', '2018-03-26 23:09:36', '2018-03-26 23:13:00', '0:0:0:0:0:0:0:1', b'0'),
	(16, 'USR1513438024801', '2018-03-26 23:13:11', '2018-03-27 08:08:32', '0:0:0:0:0:0:0:1', b'0'),
	(17, 'USR1513438024801', '2018-03-27 08:54:09', '2018-03-27 09:26:41', '0:0:0:0:0:0:0:1', b'0'),
	(18, 'USR1513438024801', '2018-03-27 09:49:17', '2018-03-27 10:26:42', '0:0:0:0:0:0:0:1', b'1');
